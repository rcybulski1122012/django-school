...
class EventModelTestCase(UsersMixin, ClassesMixin, EventsMixin, TestCase):
    ...
    def test_clean_raises_ValidationError_if_date_is_not_in_future(self):
...
class EventQuerySetTestCase(UsersMixin, ClassesMixin, EventsMixin, TestCase):
    ...
    def test_visible_to_user_selects_events_created_by_teacher_if_user_is_teacher(self):
    ...
    def test_visible_to_user_selects_events_of_student_class_if_user_is_student(self):
    ...
    def test_visible_to_user_select_events_of_parent_child_class_if_user_is_parent(
        self,
    ):
        student = self.create_student(school_class=self.school_class)
